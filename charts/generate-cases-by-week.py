...
plt.legend()
#plt.show()
plt.savefig('./charts/output/cases-by-week.png', transparent=True)
...
plt.legend()
#plt.show()
plt.savefig('./charts/output/cases-by-week.bar.png', transparent=True)
...
#plt.show()
plt.savefig('./charts/output/cases-by-week.bar.student.png', transparent=True)
...
plt.ylabel('Confirmed student covid cases')
#plt.show()
plt.savefig('./charts/output/cases-by-week.bar.staff.png', transparent=True)
